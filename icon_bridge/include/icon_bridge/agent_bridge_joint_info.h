#ifndef INTRINSIC_ICON_ACTIONS_AGENT_BRIDGE_JOINT_INFO_H_
#define INTRINSIC_ICON_ACTIONS_AGENT_BRIDGE_JOINT_INFO_H_
...
// agent bridge action.
struct AgentBridgeJointInfo {
  // AgentBridgeJoint action type name and description
  static constexpr char kStreamingCommandName[] =
      "agent-bridge-joint-motion-update";
  static constexpr char kActionTypeName[] = "intrinsic.agent_bridge_joint";
  ...
  static constexpr char kSecondsSinceLastCommand[] =
      "intrinsic.agent_bridge_joint.seconds_since_last_command";
  ...
  using FixedParams =
      ::intrinsic_proto::icon::actions::proto::AgentBridgeJointCommand;
...
#endif  // INTRINSIC_ICON_ACTIONS_AGENT_BRIDGE_JOINT_INFO_H_
