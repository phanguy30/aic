...
> [!NOTE]
> **Prerequisites:** Before running these policies, ensure you have the evaluation environment running. See [Getting Started](./getting_started.md) for setup instructions.
>
> **Command Format:**
...
![Wave Arm Policy](./_static/assets/wave_arm_policy.gif)
...
![Cheat Code Policy](./_static/assets/cheat_code_policy.gif)
...
![Run ACT Policy](./_static/assets/run_act_policy.gif)
...
You may need to modify `pixi.toml` in order to run `lerobot` with your hardware setup. See [Troubleshooting](./troubleshooting.md#nvidia-rtx-50xx-cards-not-supported-on-pytorch-version-locked-in-pixi). 
...
For expected scoring results and reproducible test commands for each policy, see the [Scoring Test & Evaluation Guide](./scoring_tests.md).
